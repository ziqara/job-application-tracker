...
> Я пришёл из C# (WinForms / консоль) и осваиваю веб. Код пишу сам, поэтому местами
> он наивный — это осознанно, репозиторий про процесс обучения, а не про идеальную
> архитектуру.
